...
import { Bech32DecodingError, bech32PaddedToBin, binToBech32Padded, binToUtf8, BitRegroupingError, decodeBech32, encodeBech32, isBech32CharacterSet, regroupBits, } from '../lib';
test('regroupBits', (t) => {
...
testProp('[fast-check] encodeBech32 <-> decodeBech32', [fc.array(fc.integer(0, max5BitNumber), 0, maxBinLength)], (t, input) => {
