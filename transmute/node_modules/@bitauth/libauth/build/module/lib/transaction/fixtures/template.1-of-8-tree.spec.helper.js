 ...
 */
export const oneOfEightTreeSig = {
    ...{
 ...
 - # - each respective public key`,
    entities: [1, 2, 3, 4, 5, 6, 7, 8].reduce((acc, i) => ({
        ...acc,
        [`signer_${i}`]: {
            name: `Signer ${i}`,
    ...
    scripts: {
        ...
        ...[
            ...
            [7, 8, 3, 1],
            [8, 7, 3, 1],
        ].reduce((acc, [key, sibling, bSibling, aSibling]) => ({
            ...acc,
            [`unlock_${key}`]: {
