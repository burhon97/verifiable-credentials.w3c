...
import { bigIntToBinUint64LE, decodeTransaction, encodeTransaction, getTransactionHash, getTransactionHashBE, getTransactionHashLE, hexToBin, instantiateSha256, TransactionDecodingError, } from '../lib';
...
test('encodeTransaction', (t) => {
    ...
    t.deepEqual(encodeTransaction(tx), hexToBin(''));
});
test('decode and encode transaction', (t) => {
    ...
    t.deepEqual(hexToBin(tx), encodeTransaction(decodeTransaction(hexToBin(tx))));
});
test('decodeTransaction: invalid', (t) => {
    t.deepEqual(decodeTransaction(hexToBin('00')), TransactionDecodingError.invalidFormat);
});
test('getTransactionHash, getTransactionHashBE, getTransactionHashLE', async (t) => {
    ...
    t.deepEqual(getTransactionHashLE(sha256, hexToBin(tx)), hexToBin(txid).reverse());
});
