...
import { authenticationTemplateP2pkh, authenticationTemplateP2pkhNonHd, authenticationTemplateToCompilationEnvironment, authenticationTemplateToCompilationEnvironmentVirtualizedTests, createCompilerCommonSynchronous, hexToBin, stringify, stringifyTestVector, } from '../lib';
...
test('authenticationTemplateToCompilationEnvironment: authenticationTemplateP2pkh', (t) => {
    const environment = authenticationTemplateToCompilationEnvironment(authenticationTemplateP2pkh);
    t.deepEqual(environment, {
        entityOwnership: {
            key: 'owner',
        },
