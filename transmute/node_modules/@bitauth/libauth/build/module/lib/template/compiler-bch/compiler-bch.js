import { instantiateRipemd160, instantiateSecp256k1, instantiateSha1, instantiateSha256, instantiateSha512, } from '../../crypto/crypto';
import { generateSigningSerializationBCH, SigningSerializationFlag, } from '../../vm/instruction-sets/common/signing-serialization';
import { createInstructionSetBCH, generateBytecodeMap, getFlagsForInstructionSetBCH, instructionSetBCHCurrentStrict, OpcodesBCH, } from '../../vm/instruction-sets/instruction-sets';
import { createAuthenticationVirtualMachine } from '../../vm/virtual-machine';
import { authenticationTemplateToCompilationEnvironment, createAuthenticationProgramEvaluationCommon, createCompiler, } from '../compiler';
import { attemptCompilerOperations, compilerOperationAttemptBytecodeResolution, compilerOperationHelperCompileScript, compilerOperationHelperDeriveHdKeyPrivate, compilerOperationHelperGenerateCoveredBytecode, compilerOperationRequires, } from '../compiler-operation-helpers';
...
export const compilerOperationHelperComputeSignatureBCH = ({ coveredBytecode, identifier, transactionContext, operationName, privateKey, sha256, sign, }) => {
...
export const compilerOperationHelperComputeDataSignatureBCH = ({ data, environment, identifier, operationName, privateKey, sha256, sign, }) => {
 ...
 */
export const createCompilerBCH = async (scriptsAndOverrides) => {
 ...
 */
export const authenticationTemplateToCompilerBCH = async (template, overrides) => createCompilerBCH({
    ...overrides,
