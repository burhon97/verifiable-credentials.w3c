...
import { AuthenticationErrorCommon, compileBtl, containsRange, createAuthenticationProgramEvaluationCommon, createCompilerBCH, createCompilerCommonSynchronous, extractBytecodeResolutions, extractEvaluationSamples, extractEvaluationSamplesRecursive, extractUnexecutedRanges, hexToBin, instantiateVirtualMachineBCH, mergeRanges, OpcodesCommon, stringifyErrors, stringifyTestVector, } from '../../lib';
test('mergeRanges', (t) => {
...
test('compileBtl', (t) => {
    ...
    t.deepEqual(failed, 'BTL compilation error: [1, 2]: Unknown identifier "bad".', stringifyTestVector(failed));
});
