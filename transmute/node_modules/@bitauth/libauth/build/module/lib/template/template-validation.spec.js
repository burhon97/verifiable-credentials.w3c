...
import { BuiltInVariables, stringify, validateAuthenticationTemplate, } from '../lib';
...
test('must be an object', testValidation, 'a string', 'A valid authentication template must be an object.');
test('must be version 0', testValidation, { version: 1 }, 'Only version 0 authentication templates are currently supported.');
test('must provide a "supported" property', testValidation, { supported: 42, version: 0 }, 'Version 0 authentication templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_2022_11_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
test('must use only known virtual machine identifiers in "supported"', testValidation, { supported: ['not supported'], version: 0 }, 'Version 0 authentication templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_2022_11_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
test('may not have empty items in "supported"', testValidation, 
...
test('"$schema" must be a string (if present)', testValidation, { $schema: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "$schema" property of an authentication template must be a string.');
test('"name" must be a string (if present)', testValidation, { name: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "name" property of an authentication template must be a string.');
test('"description" must be a string (if present)', testValidation, { description: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "description" property of an authentication template must be a string.');
test('"entities" must be a an object', testValidation, { entities: 42, scripts: {}, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "entities" property of an authentication template must be an object.');
test('"scripts" must be a an object', testValidation, { entities: {}, scripts: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "scripts" property of an authentication template must be an object.');
test('"scenarios" must be a an object (if present)', testValidation, {
    entities: {},
    scenarios: 42,
    scripts: {},
...
test('script shapes are checked', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: 42 },
    supported: ['BCH_2022_11_SPEC'],
...
test('empty script object', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: {} },
    supported: ['BCH_2022_11_SPEC'],
...
test('unlocking script, no content', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: { unlocks: 'b' } },
    supported: ['BCH_2022_11_SPEC'],
...
test('unlocking script, invalid unlocks', testValidation, {
    entities: {},
    scenarios: {},
...
test('unknown locking script', testValidation, {
    entities: {},
    scenarios: {},
...
test('unlocking script, invalid timeLockType', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, invalid ageLock', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, invalid estimate', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, invalid passes', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, invalid fails', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, invalid "invalid"', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, empty passes item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        // eslint-disable-next-line no-sparse-arrays
...
test('unlocking script, non-string fails item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, non-string invalid item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('locking script, no type', testValidation, {
    entities: {},
    scenarios: {},
...
test('locking script, no contents', testValidation, {
    entities: {},
    scenarios: {},
...
test('locking script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', unlocks: 'b' },
...
test('tested script, no contents', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { tests: [] },
...
test('tested script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('tested script, invalid tests', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', tests: 42 },
...
test('tested script, test with no check', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', tests: [{ name: '' }] },
...
test('tested script, invalid test name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('tested script, invalid test setup', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('tested script, invalid passes', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('tested script, invalid fails', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('tested script, invalid "invalid"', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('tested script, invalid pushed', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test("tested script, can't test a locking script", testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('other script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
...
test('invalid entity', testValidation, {
    entities: { e: 42 },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_2022_11_SPEC'],
...
test('invalid entity description', testValidation, {
...
test('invalid entity name', testValidation, {
    entities: { e: { name: 42 } },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_2022_11_SPEC'],
...
test('invalid entity scripts', testValidation, {
    entities: { e: { scripts: '' } },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_2022_11_SPEC'],
...
test('invalid entity scripts items', testValidation, {
    // eslint-disable-next-line no-sparse-arrays
...
test('invalid entity variables', testValidation, {
...
test('variable, wrong type', testValidation, {
...
test('variable, no type', testValidation, {
...
test('variable, invalid description', testValidation, {
    entities: {
...
test('variable, invalid name', testValidation, {
    entities: {
...
test('HdKey variable, invalid addressOffset', testValidation, {
    entities: {
...
test('HdKey variable, invalid hdPublicKeyDerivationPath', testValidation, {
    entities: {
...
test('HdKey variable, invalid privateDerivationPath', testValidation, {
    entities: {
...
test('HdKey variable, invalid publicDerivationPath', testValidation, {
    entities: {
...
test('HdKey variable, invalid privateDerivationPath content', testValidation, {
    entities: {
...
test('HdKey variable, invalid hdPublicKeyDerivationPath content', testValidation, {
    entities: {
        e: {
...
test('HdKey variable, invalid publicDerivationPath content', testValidation, {
    entities: {
        e: {
...
test('HdKey variable, invalid implied private derivation path', testValidation, {
    entities: {
        e: {
            variables: {
                v: {
...
test('Scenario, invalid type', testValidation, {
    entities: {},
    scenarios: { a: '' },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
test('Scenario, invalid name', testValidation, {
    entities: {},
    scenarios: { a: { name: 1 } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
test('Scenario, invalid description', testValidation, {
    entities: {},
...
test('Scenario, invalid extends', testValidation, {
    entities: {},
...
test('Scenario, unknown extends', testValidation, {
    entities: {},
...
test('Scenario, invalid value (negative)', testValidation, {
    entities: {},
    scenarios: { a: { value: -1 } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
test('Scenario, invalid value (greater than Number.MAX_SAFE_INTEGER)', testValidation, {
    entities: {},
...
test('Scenario, invalid value (insufficient hex)', testValidation, {
    entities: {},
    scenarios: { a: { value: '' } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
test('Scenario, invalid data', testValidation, {
    entities: {},
    scenarios: { a: { data: '' } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
test('Scenario, invalid bytecode', testValidation, {
    entities: {},
...
test('Scenario, invalid currentBlockHeight (string)', testValidation, {
    entities: {},
...
test('Scenario, invalid currentBlockHeight (negative)', testValidation, {
    entities: {},
...
test('Scenario, invalid currentBlockHeight (decimal)', testValidation, {
    entities: {},
...
test('Scenario, invalid currentBlockHeight (exceeds maximum)', testValidation, {
    entities: {},
...
test('Scenario, invalid currentBlockTime (below minimum)', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys.addressIndex (string)', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys.addressIndex (negative)', testValidation, {
    entities: {},
    scenarios: { a: { data: { hdKeys: { addressIndex: -1 } } } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
test('Scenario, invalid data.hdKeys.addressIndex (decimal)', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys.addressIndex (exceeds maximum)', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys.hdPublicKeys', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys.hdPublicKeys (non-string value)', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys.hdPrivateKeys', testValidation, {
    entities: {},
...
test('Scenario, invalid data.hdKeys.hdPrivateKeys (non-string value)', testValidation, {
    entities: {},
...
test('Scenario, invalid data.keys', testValidation, {
    entities: {},
...
test('Scenario, invalid data.keys.privateKeys', testValidation, {
    entities: {},
...
test('Scenario, invalid data.keys.privateKeys (non-string value)', testValidation, {
    entities: {},
...
test('Scenario, invalid transaction', testValidation, {
    entities: {},
...
test('Scenario, invalid transaction.locktime', testValidation, {
    entities: {},
...
test('Scenario, invalid transaction.version', testValidation, {
    entities: {},
...
test('Scenario, invalid transaction.inputs (no inputs)', testValidation, {
    entities: {},
...
test('Scenario, invalid transaction.inputs (sparse array)', testValidation, {
    entities: {},
    scenarios: {
        // eslint-disable-next-line no-sparse-arrays
...
test('Scenario, invalid transaction input outpointIndex (negative)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction input outpointTransactionHash (non-string)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction input outpointTransactionHash (incorrect length)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction input sequenceNumber', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction input unlockingBytecode', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, empty transaction.outputs', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction.outputs (sparse array)', testValidation, {
    entities: {},
    scenarios: {
        // eslint-disable-next-line no-sparse-arrays
...
test('Scenario, invalid transaction output lockingBytecode type', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction output lockingBytecode (non-hex)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction output lockingBytecode.script', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction output lockingBytecode.override', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, invalid transaction output satoshis', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('built-in identifiers may not be re-used', testValidation, {
...
test('all IDs must be unique', testValidation, {
    entities: { a: {}, b: {}, d: {} },
    scenarios: { b: {} },
...
test('all entity script IDs must exist', testValidation, {
...
test('all scenarios reference by scripts must exist', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: {
...
test('all entities referenced by data.hdKeys must exist', testValidation, {
    entities: { a: {}, b: {} },
    scenarios: {
        s: {
            data: {
