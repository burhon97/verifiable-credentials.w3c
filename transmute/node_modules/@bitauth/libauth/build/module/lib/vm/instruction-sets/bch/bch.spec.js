...
import { createAuthenticationProgramStateCommonEmpty, createTestAuthenticationProgramBCH, hexToBin, instantiateSha256, instantiateVirtualMachineBCH, OpcodesBCH, parseBytecode, } from '../../../lib';
test('[BCH VM] vm.stateEvaluate: OP_2 OP_2 OP_ADD', async (t) => {
    ...
    const state = createAuthenticationProgramStateCommonEmpty({
        instructions: parseBytecode(Uint8Array.from([OpcodesBCH.OP_2, OpcodesBCH.OP_2, OpcodesBCH.OP_ADD])),
    });
...
test('[BCH VM] vm.evaluate: only lockingBytecode: OP_2 OP_2 OP_ADD', async (t) => {
    ...
    t.deepEqual(result, {
        ...
        operationCount: 1,
        outpointIndex: 0,
        outpointTransactionHash: hexToBin('e3d27808b1d16719d2690e9a30de9d69c52c33916a0c491d0aa0a98c56d6c2af'),
        outputValue: hexToBin('0000000000000000'),
        sequenceNumber: 4294967295,
        signatureOperationsCount: 0,
        signedMessages: [],
        stack: [Uint8Array.of(0x04)],
        transactionOutpoints: hexToBin('afc2d6568ca9a00a1d490c6a91332cc5699dde309a0e69d21967d1b10878d2e300000000'),
