...
import { bigIntToScriptNumber, binToHex, booleanToScriptNumber, hexToBin, parseBytesAsScriptNumber, ScriptNumberError, stackItemIsTruthy, } from '../../../lib';
/**
...
test('parseBytesAsScriptNumber', (t) => {
    minimallyEncodedScriptNumbers.map((pair) => {
        ...
        t.deepEqual(parseBytesAsScriptNumber(hexToBin(pair[0]), {
    ...
    t.deepEqual(parseBytesAsScriptNumber(hexToBin('abcdef1234')), ScriptNumberError.outOfRange);
    t.deepEqual(parseBytesAsScriptNumber(hexToBin('abcdef1234'), {
        maximumScriptNumberByteLength: 5,
    }), BigInt(223656005035));
});
