...
const testValidation = (t, input, expected) => {
    const result = lib_1.validateAuthenticationTemplate(input);
    t.deepEqual(result, expected, lib_1.stringify(result));
};
// eslint-disable-next-line functional/immutable-data
testValidation.title = (title) => `validateAuthenticationTemplate: ${title !== null && title !== void 0 ? title : '?'}`;
ava_1.default('must be an object', testValidation, 'a string', 'A valid authentication template must be an object.');
ava_1.default('must be version 0', testValidation, { version: 1 }, 'Only version 0 authentication templates are currently supported.');
ava_1.default('must provide a "supported" property', testValidation, { supported: 42, version: 0 }, 'Version 0 authentication templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_2022_11_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
ava_1.default('must use only known virtual machine identifiers in "supported"', testValidation, { supported: ['not supported'], version: 0 }, 'Version 0 authentication templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_2022_11_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
ava_1.default('may not have empty items in "supported"', testValidation, 
// eslint-disable-next-line no-sparse-arrays
{ supported: ['BCH_2020_05', , 'BCH_2020_11_SPEC'], version: 0 }, 'Version 0 authentication templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_2022_11_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
ava_1.default('"$schema" must be a string (if present)', testValidation, { $schema: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "$schema" property of an authentication template must be a string.');
ava_1.default('"name" must be a string (if present)', testValidation, { name: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "name" property of an authentication template must be a string.');
ava_1.default('"description" must be a string (if present)', testValidation, { description: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "description" property of an authentication template must be a string.');
ava_1.default('"entities" must be a an object', testValidation, { entities: 42, scripts: {}, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "entities" property of an authentication template must be an object.');
ava_1.default('"scripts" must be a an object', testValidation, { entities: {}, scripts: 42, supported: ['BCH_2022_11_SPEC'], version: 0 }, 'The "scripts" property of an authentication template must be an object.');
ava_1.default('"scenarios" must be a an object (if present)', testValidation, {
    entities: {},
    scenarios: 42,
    scripts: {},
...
ava_1.default('script shapes are checked', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: 42 },
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('empty script object', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: {} },
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('unlocking script, no content', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: { unlocks: 'b' } },
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('unlocking script, invalid unlocks', testValidation, {
    entities: {},
    scenarios: {},
...
ava_1.default('unknown locking script', testValidation, {
    entities: {},
    scenarios: {},
...
ava_1.default('unlocking script, invalid timeLockType', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, invalid ageLock', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, invalid estimate', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, invalid passes', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, invalid fails', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, invalid "invalid"', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, empty passes item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        // eslint-disable-next-line no-sparse-arrays
...
ava_1.default('unlocking script, non-string fails item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, non-string invalid item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('unlocking script, valid ageLock', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('locking script, no type', testValidation, {
    entities: {},
    scenarios: {},
...
ava_1.default('locking script, no contents', testValidation, {
    entities: {},
    scenarios: {},
...
ava_1.default('locking script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', unlocks: 'b' },
...
ava_1.default('tested script, no contents', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { tests: [] },
...
ava_1.default('tested script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('tested script, invalid tests', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', tests: 42 },
...
ava_1.default('tested script, test with no check', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', tests: [{ name: '' }] },
...
ava_1.default('tested script, invalid test name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('tested script, invalid test setup', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('tested script, invalid passes', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('tested script, invalid fails', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('tested script, invalid "invalid"', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('tested script, invalid pushed', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('tested script, valid test', testValidation, {
    entities: {},
    scenarios: { s1: {}, s2: {}, s3: {} },
    scripts: {
        a: {
...
ava_1.default("tested script, can't test a locking script", testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
ava_1.default('other script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
...
ava_1.default('invalid entity', testValidation, {
    entities: { e: 42 },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('invalid entity description', testValidation, {
...
ava_1.default('invalid entity name', testValidation, {
    entities: { e: { name: 42 } },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('invalid entity scripts', testValidation, {
    entities: { e: { scripts: '' } },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('invalid entity scripts items', testValidation, {
    // eslint-disable-next-line no-sparse-arrays
...
ava_1.default('invalid entity variables', testValidation, {
...
ava_1.default('variable, wrong type', testValidation, {
...
ava_1.default('variable, no type', testValidation, {
...
ava_1.default('variable, invalid description', testValidation, {
    entities: {
...
ava_1.default('variable, invalid name', testValidation, {
    entities: {
...
ava_1.default('HdKey variable, invalid addressOffset', testValidation, {
    entities: {
...
ava_1.default('HdKey variable, invalid hdPublicKeyDerivationPath', testValidation, {
    entities: {
...
ava_1.default('HdKey variable, invalid privateDerivationPath', testValidation, {
    entities: {
...
ava_1.default('HdKey variable, invalid publicDerivationPath', testValidation, {
    entities: {
...
ava_1.default('HdKey variable, invalid privateDerivationPath content', testValidation, {
    entities: {
...
ava_1.default('HdKey variable, invalid hdPublicKeyDerivationPath content', testValidation, {
    entities: {
        e: {
...
ava_1.default('HdKey variable, invalid publicDerivationPath content', testValidation, {
    entities: {
        e: {
...
ava_1.default('HdKey variable, invalid implied private derivation path', testValidation, {
    entities: {
        e: {
            variables: {
                v: {
...
ava_1.default('AddressData variable, valid', testValidation, {
...
ava_1.default('HdKey variable, valid', testValidation, {
    entities: {
        e: {
            variables: {
                v: {
...
ava_1.default('Scenario, invalid type', testValidation, {
    entities: {},
    scenarios: { a: '' },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, invalid name', testValidation, {
    entities: {},
    scenarios: { a: { name: 1 } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, invalid description', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid extends', testValidation, {
    entities: {},
...
ava_1.default('Scenario, unknown extends', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid value (negative)', testValidation, {
    entities: {},
    scenarios: { a: { value: -1 } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, invalid value (greater than Number.MAX_SAFE_INTEGER)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid value (insufficient hex)', testValidation, {
    entities: {},
    scenarios: { a: { value: '' } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, value (hex)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data', testValidation, {
    entities: {},
    scenarios: { a: { data: '' } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, empty data', testValidation, {
    entities: {},
    scenarios: { a: { data: {} } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, invalid bytecode', testValidation, {
    entities: {},
...
ava_1.default('Scenario, valid bytecode', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid currentBlockHeight (string)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid currentBlockHeight (negative)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid currentBlockHeight (decimal)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid currentBlockHeight (exceeds maximum)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, valid currentBlockHeight', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid currentBlockTime (below minimum)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, valid currentBlockTime', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys.addressIndex (string)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys.addressIndex (negative)', testValidation, {
    entities: {},
    scenarios: { a: { data: { hdKeys: { addressIndex: -1 } } } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, invalid data.hdKeys.addressIndex (decimal)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys.addressIndex (exceeds maximum)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys.hdPublicKeys', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys.hdPublicKeys (non-string value)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys.hdPrivateKeys', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.hdKeys.hdPrivateKeys (non-string value)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, valid data.hdKeys', testValidation, {
    entities: { e: {}, f: {} },
    scenarios: {
        a: {
            data: {
...
ava_1.default('Scenario, invalid data.keys', testValidation, {
    entities: {},
...
ava_1.default('Scenario, empty data.keys', testValidation, {
    entities: {},
    scenarios: { a: { data: { keys: {} } } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, invalid data.keys.privateKeys', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid data.keys.privateKeys (non-string value)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, valid data.keys', testValidation, {
    entities: {},
    scenarios: {
        a: {
            data: {
...
ava_1.default('Scenario, invalid transaction', testValidation, {
    entities: {},
...
ava_1.default('Scenario, empty transaction', testValidation, {
    entities: {},
    scenarios: { a: { transaction: {} } },
    scripts: {},
    supported: ['BCH_2022_11_SPEC'],
...
ava_1.default('Scenario, invalid transaction.locktime', testValidation, {
    entities: {},
...
ava_1.default('Scenario, valid transaction.locktime', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid transaction.version', testValidation, {
    entities: {},
...
ava_1.default('Scenario, valid transaction.version', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid transaction.inputs (no inputs)', testValidation, {
    entities: {},
...
ava_1.default('Scenario, invalid transaction.inputs (sparse array)', testValidation, {
    entities: {},
    scenarios: {
        // eslint-disable-next-line no-sparse-arrays
...
ava_1.default('Scenario, invalid transaction input outpointIndex (negative)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction input outpointTransactionHash (non-string)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction input outpointTransactionHash (incorrect length)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction input sequenceNumber', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction input unlockingBytecode', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, valid transaction.inputs', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, empty transaction.outputs', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction.outputs (sparse array)', testValidation, {
    entities: {},
    scenarios: {
        // eslint-disable-next-line no-sparse-arrays
...
ava_1.default('Scenario, invalid transaction output lockingBytecode type', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction output lockingBytecode (non-hex)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction output lockingBytecode.script', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction output lockingBytecode.override', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, invalid transaction output satoshis', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('Scenario, valid transaction output', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
ava_1.default('built-in identifiers may not be re-used', testValidation, {
    entities: { [lib_1.BuiltInVariables.currentBlockHeight]: {} },
    scripts: { [lib_1.BuiltInVariables.signingSerialization]: { script: '' } },
    supported: ['BCH_2022_11_SPEC'],
    version: 0,
...
ava_1.default('all IDs must be unique', testValidation, {
    entities: { a: {}, b: {}, d: {} },
    scenarios: { b: {} },
...
ava_1.default('all entity script IDs must exist', testValidation, {
...
ava_1.default('all scenarios reference by scripts must exist', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: {
...
ava_1.default('all entities referenced by data.hdKeys must exist', testValidation, {
    entities: { a: {}, b: {} },
    scenarios: {
        s: {
            data: {
...
//# sourceMappingURL=template-validation.spec.js.map