...
const testSecp256k1Wasm = (t, secp256k1Wasm) => {
    ...
    const contextPtr = secp256k1Wasm.contextCreate(lib_1.ContextFlag.BOTH);
    {
    ...
    secp256k1Wasm.pubkeySerialize(contextPtr, uncompressedOutputPtr, uncompressedOutputLengthPtr, rawPubkeyPtr, lib_1.CompressionFlag.UNCOMPRESSED);
    ...
    secp256k1Wasm.pubkeySerialize(contextPtr, compressedOutputPtr, compressedOutputLengthPtr, rawPubkeyPtr, lib_1.CompressionFlag.COMPRESSED);
    ...
    t.is(secp256k1Wasm.pubkeySerialize(contextPtr, compressedOutput2Ptr, compressedOutput2LengthPtr, rawPubkey2Ptr, lib_1.CompressionFlag.COMPRESSED), 1);
    ...
    secp256k1Wasm.pubkeySerialize(contextPtr, recoveredPublicKeyCompressedPtr, recoveredPublicKeyCompressedLengthPtr, recoveredPublicKeyPtr, lib_1.CompressionFlag.COMPRESSED);
    ...
    secp256k1Wasm.pubkeySerialize(contextPtr, pubkeyDerivedTweakedAddCompressedPtr, pubkeyDerivedTweakedAddCompressedLengthPtr, rawPubkeyDerivedTweakedAddPtr, lib_1.CompressionFlag.COMPRESSED);
    ...
    secp256k1Wasm.pubkeySerialize(contextPtr, pubkeyTweakedAddCompressedPtr, pubkeyTweakedAddCompressedLengthPtr, rawPubkeyTweakedAddPtr, lib_1.CompressionFlag.COMPRESSED);
    ...
    secp256k1Wasm.pubkeySerialize(contextPtr, pubkeyDerivedTweakedMulCompressedPtr, pubkeyDerivedTweakedMulCompressedLengthPtr, rawPubkeyDerivedTweakedMulPtr, lib_1.CompressionFlag.COMPRESSED);
    ...
    secp256k1Wasm.pubkeySerialize(contextPtr, pubkeyTweakedMulCompressedPtr, pubkeyTweakedMulCompressedLengthPtr, rawPubkeyTweakedMulPtr, lib_1.CompressionFlag.COMPRESSED);
...
ava_1.default('[crypto] getEmbeddedSecp256k1Binary returns the proper binary', (t) => {
...
ava_1.default('[crypto] Secp256k1Wasm instantiated with embedded binary', async (t) => {
    const secp256k1Wasm = await lib_1.instantiateSecp256k1Wasm();
    testSecp256k1Wasm(t, secp256k1Wasm);
});
ava_1.default('[crypto] Secp256k1Wasm instantiated with bytes', async (t) => {
    const secp256k1Wasm = await lib_1.instantiateSecp256k1WasmBytes(binary);
    testSecp256k1Wasm(t, secp256k1Wasm);
});
