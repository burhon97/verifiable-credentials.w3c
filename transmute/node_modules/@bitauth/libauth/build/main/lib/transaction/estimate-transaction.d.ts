...
import { TransactionContextCommon, TransactionGenerationAttempt, TransactionTemplateEstimated } from './transaction-types';
/**
 ...
 */
export declare const estimateTransaction: <CompilerType extends Compiler<TransactionContextCommon, unknown, unknown>>(template: Readonly<TransactionTemplateEstimated<CompilerType>>) => TransactionGenerationAttempt;
