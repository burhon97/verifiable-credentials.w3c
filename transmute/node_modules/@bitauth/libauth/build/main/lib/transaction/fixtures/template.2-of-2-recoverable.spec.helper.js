...
exports.twoOfTwoRecoverable = void 0;
/* eslint-disable camelcase, @typescript-eslint/naming-convention */
const compiler_defaults_1 = require("../../template/compiler-defaults");
const secondsIn30Days = 2592000;
exports.twoOfTwoRecoverable = Object.assign({ name: '2-of-2 Recoverable Vault' }, { $schema: 'https://bitauth.com/schemas/authentication-template-v0.schema.json', description: 'A 2-of-2 wallet, which after a specified delay, can be recovered by either of the original two keys and a signature from a trusted user (e.g. an attorney).\n\nIn this implementation, all wallet addresses become recoverable at the same time. To "bump" the recovery time to a later date, create a new wallet and transfer the funds.\n\nThis scheme is described in more detail in BIP-65.', entities: {
        signer_1: {
        ...
        after_recovery_time: {
            ...
            transaction: {
                locktime: compiler_defaults_1.CompilerDefaults.defaultScenarioCurrentBlockTime +
                    secondsIn30Days,
            },
        },
