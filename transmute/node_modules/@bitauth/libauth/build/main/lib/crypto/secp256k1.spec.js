...
ava_1.default('[crypto] secp256k1.signMessageHashCompact', async (t) => {
    ...
    t.notDeepEqual(secp256k1.signMessageHashCompact(privkey, Uint8Array.of()), sigCompact);
...
ava_1.default('[crypto] secp256k1.signMessageHashDER', async (t) => {
    ...
    t.notDeepEqual(secp256k1.signMessageHashDER(privkey, Uint8Array.of()), sigDER);
...
ava_1.default('[crypto] secp256k1.validatePublicKey', async (t) => {
    const secp256k1 = await secp256k1Promise;
...
ava_1.default.todo('[fast-check] [crypto] secp256k1.validatePublicKey');
ava_1.default('[crypto] secp256k1.verifySignatureCompact', async (t) => {
    ...
    t.false(secp256k1.verifySignatureCompact(sigCompactHighS, pubkeyCompressed, Uint8Array.of()));
    t.true(secp256k1.verifySignatureCompact(sigCompactHighS, pubkeyCompressed, messageHash));
    t.false(secp256k1.verifySignatureCompact(Uint8Array.of(), pubkeyCompressed, messageHash));
});
...
ava_1.default('[crypto] secp256k1.verifySignatureCompactLowS', async (t) => {
    ...
    t.false(secp256k1.verifySignatureCompactLowS(Uint8Array.of(), pubkeyCompressed, messageHash));
    t.true(secp256k1.verifySignatureCompactLowS(sigCompact, pubkeyCompressed, messageHash));
    t.false(secp256k1.verifySignatureCompactLowS(sigCompact, pubkeyCompressed, Uint8Array.of()));
});
...
ava_1.default('[crypto] secp256k1.verifySignatureDER', async (t) => {
    ...
    t.false(secp256k1.verifySignatureDER(Uint8Array.of(), pubkeyCompressed, messageHash));
    t.true(secp256k1.verifySignatureDER(sigDERHighS, pubkeyCompressed, messageHash));
    t.false(secp256k1.verifySignatureDER(sigDERHighS, pubkeyCompressed, Uint8Array.of()));
});
ava_1.default('[crypto] secp256k1.verifySignatureDERLowS', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.verifySignatureDERLowS(sigDER, pubkeyCompressed, messageHash));
    t.false(secp256k1.verifySignatureDERLowS(Uint8Array.of(), pubkeyCompressed, messageHash));
    t.true(secp256k1.verifySignatureDERLowS(sigDER, pubkeyCompressed, messageHash));
    t.false(secp256k1.verifySignatureDERLowS(sigDER, pubkeyCompressed, Uint8Array.of()));
...
ava_1.default('[crypto] secp256k1.verifySignatureSchnorr', async (t) => {
    const secp256k1 = await secp256k1Promise;
    t.true(secp256k1.verifySignatureSchnorr(sigSchnorr, pubkeyCompressed, schnorrMsgHash));
    t.false(secp256k1.verifySignatureSchnorr(Uint8Array.of(), pubkeyCompressed, schnorrMsgHash));
    const pubkeyWithBrokenEncoding = pubkeyCompressed.slice().fill(0, 0, 1);
