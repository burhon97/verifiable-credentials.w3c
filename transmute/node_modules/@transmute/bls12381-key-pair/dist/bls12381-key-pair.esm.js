...
var Bls12381G1KeyPair = Bls12381G1KeyPair_1 = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt("return", exportableTypes[options.type](BlsCurveName.G1, this.id, this.controller, this.publicKey, options.privateKey ? this.privateKey : undefined));
...
Bls12381G1KeyPair.generate = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            seed = secureRandom();
            _context5.next = 4;
            return Bls12381G1KeyPair$1.generate({
              seed: seed
            });
...
Bls12381G1KeyPair.from = /*#__PURE__*/function () {
...
Bls12381G1KeyPair = Bls12381G1KeyPair_1 = /*#__PURE__*/__decorate([/*#__PURE__*/staticImplements()], Bls12381G1KeyPair);
...
var Bls12381G2KeyPair = Bls12381G2KeyPair_1 = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt("return", exportableTypes[options.type](BlsCurveName.G2, this.id, this.controller, this.publicKey, options.privateKey ? this.privateKey : undefined));
...
Bls12381G2KeyPair.generate = /*#__PURE__*/function () {
  var _ref3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(_ref2) {
    var secureRandom, seed, k, fingerprint, controller, id;
    return runtime_1.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            seed = secureRandom();
            _context5.next = 4;
            return Bls12381G2KeyPair$1.generate({
              seed: seed
            });
...
Bls12381G2KeyPair.from = /*#__PURE__*/function () {
  var _ref4 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(k) {
    var _importableTypes$k$ty, publicKey, privateKey;
...
Bls12381G2KeyPair = Bls12381G2KeyPair_1 = /*#__PURE__*/__decorate([/*#__PURE__*/staticImplements()], Bls12381G2KeyPair);
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return generateBls12381G1KeyPair(seed);

          case 2:
            g1 = _context.sent;
            _context.next = 5;
            return generateBls12381G2KeyPair(seed);

          case 5:
            g2 = _context.sent;
            bls12381G1KeyPair = new Bls12381G1KeyPair({
              id: '',
              type: 'Bls12381G1Key2020',
              controller: '',
            ...
            bls12381G2KeyPair = new Bls12381G2KeyPair({
              id: '',
              type: 'Bls12381G2Key2020',
              controller: '',
...
export { Bls12381G1KeyPair, Bls12381G2KeyPair, Bls12381KeyPairs, BlsCurveName };
//# sourceMappingURL=bls12381-key-pair.esm.js.map
