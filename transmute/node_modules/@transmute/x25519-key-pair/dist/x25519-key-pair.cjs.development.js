...
var X25519_MULTICODEC_IDENTIFIER = 0xec;
...
exports.X25519KeyPair = X25519KeyPair_1 = /*#__PURE__*/function () {
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return X25519KeyPair_1.from(importableType);

            case 2:
              _yield$X25519KeyPair_ = _context.sent;
              publicKey = _yield$X25519KeyPair_.publicKey;
  ...
  X25519KeyPair.fromFingerprint = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              if (!(buffer[0] === X25519_MULTICODEC_IDENTIFIER && buffer[1] === VARIABLE_INTEGER_TRAILING_BYTE)) {
                _context2.next = 12;
                break;
              }

              _context2.next = 5;
              return X25519KeyPair_1.from({
                id: '',
                controller: '',
                type: 'X25519KeyAgreementKey2019',
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", getMultibaseFingerprintFromPublicKeyBytes(this.publicKey));
  ...
  _proto.deriveSecret = /*#__PURE__*/function () {
    var _deriveSecret = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(_ref2) {
      var publicKey, remote, scalarMultipleResult;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 3;
              return X25519KeyPair_1.from(publicKey);
            ...
            case 6:
              scalarMultipleResult = x25519.sharedKey(this.privateKey, remote.publicKey, true);
              return _context5.abrupt("return", scalarMultipleResult);
  ...
  _proto.toJsonWebKeyPair = /*#__PURE__*/function () {
    var _toJsonWebKeyPair = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(exportPrivateKey) {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return _context6.abrupt("return", exportableTypes['JsonWebKey2020'](this.id, this.controller, this.publicKey, exportPrivateKey ? this.privateKey : undefined));
...
exports.X25519KeyPair.generate = /*#__PURE__*/function () {
  var _ref4 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(_ref3) {
    var secureRandom, key, fingerprint, controller, id;
    return runtime_1.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            secureRandom = _ref3.secureRandom;
            ...
            return _context7.abrupt("return", new X25519KeyPair_1({
              id: id,
              type: 'JsonWebKey2020',
              controller: controller,
...
exports.X25519KeyPair.from = /*#__PURE__*/function () {
  var _ref5 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(k) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            return _context8.abrupt("return", new X25519KeyPair_1({
              id: k.id,
              type: k.type,
...
exports.X25519KeyPair = X25519KeyPair_1 = /*#__PURE__*/tslib.__decorate([/*#__PURE__*/ldKeyPair.staticImplements()], exports.X25519KeyPair);
//# sourceMappingURL=x25519-key-pair.cjs.development.js.map
